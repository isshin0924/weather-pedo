...
class ViewController: UIViewController,CLLocationManagerDelegate,UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if(CMPedometer.isStepCountingAvailable()){
            ...
            countStep = readData()
            levelLabel.text = "TotallSteps:\(String(countStep))"
            ...
            for(key, data) in jsonDictionary{
                if (key as! String == "weather"){
                    ...
                    for (eachWether) in resultArray{
                        ...
                        self.weatherLabel.text = String(describing: wether["main"]!)
                        self.weatherLabel.textColor = UIColor.white
                        
                        if String(describing: wether["main"]!)=="Clear"  {
                            // UIImageを作成.
                            let myImage: UIImage = UIImage(named: "sunnyicon.png")!
                            // 画像をUIImageViewに設定する.
                            ...
                            // アニメーション用の画像
                            let image1 = UIImage(named:"sunny.png")!
                            let image2 = UIImage(named:"sunny2.png")!
                            ...
                            imageView.center = CGPoint(x:280, y:600)
                            // view に追加する
                            ...
                            // 3回繰り返し
                            imageView.animationRepeatCount = Int(1.5)
                            // アニメーションを開始
                ...
                // Labelを作成.
                // self.weatherLabel = UILabel(frame: CGRect(x: 100, y: 120, width: self.bWidth, height: self.bHeight))
                // Textを中央寄せにする.
